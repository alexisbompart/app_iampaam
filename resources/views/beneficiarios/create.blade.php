...
<div class="container-fluid">
    <div class="form-section">
        <h1 class="text-center mb-4" style="color: #2e7d32;">
            <i class="fas fa-user-plus me-2"></i>Registro Completo de Beneficiario
        </h1>
        ...
        <form action="{{ route('beneficiarios.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" max="{{ now()->subYears(60)->format('Y-m-d') }}" required onchange="calcularEdad(this.value)">
                        @error('fecha_nacimiento') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div id="edad_calculada" class="form-text text-success fw-bold"></div>
                    </div>
                    <div class="col-md-4">
                        <label for="lugar_nacimiento" class="form-label">Lugar de Nacimiento</label>
                        <input type="text" class="form-control @error('lugar_nacimiento') is-invalid @enderror" id="lugar_nacimiento" name="lugar_nacimiento" value="{{ old('lugar_nacimiento') }}">
                        @error('lugar_nacimiento') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4">
                        <label for="nacionalidad" class="form-label">Nacionalidad</label>
                        <input type="text" class="form-control @error('nacionalidad') is-invalid @enderror" id="nacionalidad" name="nacionalidad" value="{{ old('nacionalidad', 'Venezolana') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input @error('estado_civil') is-invalid @enderror" type="radio" id="soltero" name="estado_civil" value="soltero" {{ old('estado_civil') == 'soltero' ? 'checked' : '' }} required>
                            <label class="form-check-label" for="soltero">Soltero/a</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="casado" name="estado_civil" value="casado" {{ old('estado_civil') == 'casado' ? 'checked' : '' }}>
                            <label class="form-check-label" for="casado">Casado/a</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="divorciado" name="estado_civil" value="divorciado" {{ old('estado_civil') == 'divorciado' ? 'checked' : '' }}>
                            <label class="form-check-label" for="divorciado">Divorciado/a</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="viudo" name="estado_civil" value="viudo" {{ old('estado_civil') == 'viudo' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input @error('genero') is-invalid @enderror" type="radio" id="masculino" name="genero" value="masculino" {{ old('genero') == 'masculino' ? 'checked' : '' }} required>
                            <label class="form-check-label" for="masculino">Masculino</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="femenino" name="genero" value="femenino" {{ old('genero') == 'femenino' ? 'checked' : '' }}>
                            <label class="form-check-label" for="femenino">Femenino</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="otro" name="genero" value="otro" {{ old('genero') == 'otro' ? 'checked' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nombre_conyuge') is-invalid @enderror" id="nombre_conyuge" name="nombre_conyuge" value="{{ old('nombre_conyuge') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telefono_conyuge') is-invalid @enderror" id="telefono_conyuge" name="telefono_conyuge" value="{{ old('telefono_conyuge') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('hijos') is-invalid @enderror" id="hijos" name="hijos" value="{{ old('hijos') }}" min="0">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('familiares_cercanos') is-invalid @enderror" id="familiares_cercanos" name="familiares_cercanos" rows="3">{{ old('familiares_cercanos') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telefono_alternativo') is-invalid @enderror" id="telefono_alternativo" name="telefono_alternativo" value="{{ old('telefono_alternativo') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('parroquia') is-invalid @enderror" id="parroquia" name="parroquia" value="{{ old('parroquia') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('comunidad') is-invalid @enderror" id="comunidad" name="comunidad" value="{{ old('comunidad') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('consejo_comunal') is-invalid @enderror" id="consejo_comunal" name="consejo_comunal" value="{{ old('consejo_comunal') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('centro_electoral') is-invalid @enderror" id="centro_electoral" name="centro_electoral" value="{{ old('centro_electoral') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('punto_referencia') is-invalid @enderror" id="punto_referencia" name="punto_referencia" value="{{ old('punto_referencia') }}">
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('alergias') is-invalid @enderror" id="alergias" name="alergias" value="{{ old('alergias') }}" placeholder="Medicamentos, alimentos, etc.">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('medicamentos_actuales') is-invalid @enderror" id="medicamentos_actuales" name="medicamentos_actuales" rows="2" placeholder="Nombre del medicamento, dosis, frecuencia">{{ old('medicamentos_actuales') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('enfermedades_cronicas') is-invalid @enderror" id="enfermedades_cronicas" name="enfermedades_cronicas" rows="2" placeholder="Diabetes, hipertensión, etc.">{{ old('enfermedades_cronicas') }}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('medico_cabecera') is-invalid @enderror" id="medico_cabecera" name="medico_cabecera" value="{{ old('medico_cabecera') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telefono_medico') is-invalid @enderror" id="telefono_medico" name="telefono_medico" value="{{ old('telefono_medico') }}">
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('ocupacion_anterior') is-invalid @enderror" id="ocupacion_anterior" name="ocupacion_anterior" value="{{ old('ocupacion_anterior') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('profesion') is-invalid @enderror" id="profesion" name="profesion" value="{{ old('profesion') }}" placeholder="Profesión u oficio">
                ...
                <div class="mb-3">
                    ...
                    <div class="checkbox-grid">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_familia" name="ingresos[]" value="Ayuda de la familia" {{ in_array('Ayuda de la familia', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_familia">Ayuda de la familia</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_becas" name="ingresos[]" value="Becas" {{ in_array('Becas', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_becas">Becas</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_bonos" name="ingresos[]" value="Bonos de la patria" {{ in_array('Bonos de la patria', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_bonos">Bonos de la patria</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_emprendimiento" name="ingresos[]" value="Emprendimiento" {{ in_array('Emprendimiento', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_emprendimiento">Emprendimiento</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_jubilacion" name="ingresos[]" value="Jubilacion" {{ in_array('Jubilacion', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_jubilacion">Jubilación</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_misiones" name="ingresos[]" value="Misiones" {{ in_array('Misiones', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_misiones">Misiones</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_pension_amormayor" name="ingresos[]" value="Pension amor mayor" {{ in_array('Pension amor mayor', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_pension_amormayor">Pensión amor mayor</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_pension_ivss" name="ingresos[]" value="Pension ivss" {{ in_array('Pension ivss', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_pension_ivss">Pensión IVSS</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_remesa" name="ingresos[]" value="Remesa" {{ in_array('Remesa', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_remesa">Remesa</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_renta" name="ingresos[]" value="Renta" {{ in_array('Renta', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_renta">Renta</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_trabajo" name="ingresos[]" value="Trabajo asalariado" {{ in_array('Trabajo asalariado', old('ingresos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="ingreso_trabajo">Trabajo asalariado</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ingreso_ninguno" name="ingresos[]" value="Ninguno" {{ in_array('Ninguno', old('ingresos', [])) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <div class="checkbox-grid">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_alimentacion" name="gastos[]" value="Alimentacion" {{ in_array('Alimentacion', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_alimentacion">Alimentación</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_entretenimiento" name="gastos[]" value="Entretenimiento" {{ in_array('Entretenimiento', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_entretenimiento">Entretenimiento</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_medicina" name="gastos[]" value="Medicina" {{ in_array('Medicina', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_medicina">Medicina</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_servicios" name="gastos[]" value="Servicios basicos" {{ in_array('Servicios basicos', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_servicios">Servicios básicos</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_transporte" name="gastos[]" value="Transporte" {{ in_array('Transporte', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_transporte">Transporte</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_vivienda" name="gastos[]" value="Vivienda" {{ in_array('Vivienda', old('gastos', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="gasto_vivienda">Vivienda</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gasto_otro" name="gastos[]" value="Otro" {{ in_array('Otro', old('gastos', [])) ? 'checked' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input @error('tipo_vivienda') is-invalid @enderror" type="radio" id="casa" name="tipo_vivienda" value="casa" {{ old('tipo_vivienda') == 'casa' ? 'checked' : '' }} required>
                            <label class="form-check-label" for="casa">Casa</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="apartamento" name="tipo_vivienda" value="apartamento" {{ old('tipo_vivienda') == 'apartamento' ? 'checked' : '' }}>
                            <label class="form-check-label" for="apartamento">Apartamento</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="otro_vivienda" name="tipo_vivienda" value="otro" {{ old('tipo_vivienda') == 'otro' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="propia" name="condicion_vivienda" value="propia" {{ old('condicion_vivienda') == 'propia' ? 'checked' : '' }}>
                            <label class="form-check-label" for="propia">Propia</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="alquilada" name="condicion_vivienda" value="alquilada" {{ old('condicion_vivienda') == 'alquilada' ? 'checked' : '' }}>
                            <label class="form-check-label" for="alquilada">Alquilada</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="prestada" name="condicion_vivienda" value="prestada" {{ old('condicion_vivienda') == 'prestada' ? 'checked' : '' }}>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('numero_habitantes') is-invalid @enderror" id="numero_habitantes" name="numero_habitantes" value="{{ old('numero_habitantes') }}" min="1">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('materiales_construccion') is-invalid @enderror" id="materiales_construccion" name="materiales_construccion" value="{{ old('materiales_construccion') }}" placeholder="Bloque, madera, etc.">
                ...
                <div class="mb-3">
                    ...
                    <div class="checkbox-grid">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_agua" name="servicios[]" value="Agua potable" {{ in_array('Agua potable', old('servicios', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="servicio_agua">Agua potable</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_electricidad" name="servicios[]" value="Electricidad" {{ in_array('Electricidad', old('servicios', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="servicio_electricidad">Electricidad</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_gas" name="servicios[]" value="Gas" {{ in_array('Gas', old('servicios', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="servicio_gas">Gas</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_telefono" name="servicios[]" value="Teléfono" {{ in_array('Teléfono', old('servicios', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="servicio_telefono">Teléfono</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_internet" name="servicios[]" value="Internet" {{ in_array('Internet', old('servicios', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="servicio_internet">Internet</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="servicio_cable" name="servicios[]" value="Cable TV" {{ in_array('Cable TV', old('servicios', [])) ? 'checked' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="discapacidad_si" name="tiene_discapacidad" value="si" {{ old('tiene_discapacidad') == 'si' ? 'checked' : '' }}>
                        <label class="form-check-label" for="discapacidad_si">Sí</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="discapacidad_no" name="tiene_discapacidad" value="no" {{ old('tiene_discapacidad') == 'no' ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <div class="checkbox-grid">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_fisica" name="discapacidad[]" value="Física o Motora" {{ in_array('Física o Motora', old('discapacidad', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="discapacidad_fisica">Física o Motora</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_visual" name="discapacidad[]" value="Sensorial-Visual" {{ in_array('Sensorial-Visual', old('discapacidad', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="discapacidad_visual">Sensorial-Visual</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_auditiva" name="discapacidad[]" value="Sensorial-Auditiva" {{ in_array('Sensorial-Auditiva', old('discapacidad', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="discapacidad_auditiva">Sensorial-Auditiva</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_intelectual" name="discapacidad[]" value="Intelectual o Cognitiva" {{ in_array('Intelectual o Cognitiva', old('discapacidad', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="discapacidad_intelectual">Intelectual o Cognitiva</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_psicosocial" name="discapacidad[]" value="Psicosocial o Mental" {{ in_array('Psicosocial o Mental', old('discapacidad', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="discapacidad_psicosocial">Psicosocial o Mental</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="discapacidad_ninguna" name="discapacidad[]" value="Ninguna de las anteriores" {{ in_array('Ninguna de las anteriores', old('discapacidad', [])) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('ayudas_tecnicas') is-invalid @enderror" id="ayudas_tecnicas" name="ayudas_tecnicas" rows="2" placeholder="Silla de ruedas, bastón, audífonos, etc.">{{ old('ayudas_tecnicas') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('necesidades_especiales') is-invalid @enderror" id="necesidades_especiales" name="necesidades_especiales" rows="2" placeholder="Cuidados especiales, dieta específica, etc.">{{ old('necesidades_especiales') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('persona_referencia') is-invalid @enderror" id="persona_referencia" name="persona_referencia" value="{{ old('persona_referencia') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('parentesco_referencia') is-invalid @enderror" id="parentesco_referencia" name="parentesco_referencia" value="{{ old('parentesco_referencia') }}" required placeholder="Hijo/a, nieto/a, vecino/a, etc.">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telefono_referencia') is-invalid @enderror" id="telefono_referencia" name="telefono_referencia" value="{{ old('telefono_referencia') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('direccion_referencia') is-invalid @enderror" id="direccion_referencia" name="direccion_referencia" value="{{ old('direccion_referencia') }}">
            ...
            <div class="form-section">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('actividades_formativas') is-invalid @enderror" id="actividades_formativas" name="actividades_formativas" rows="3" placeholder="Talleres, cursos, capacitaciones, charlas, etc.">{{ old('actividades_formativas') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('actividades_recreativas') is-invalid @enderror" id="actividades_recreativas" name="actividades_recreativas" rows="3" placeholder="Deportes, manualidades, música, danza, paseos, etc.">{{ old('actividades_recreativas') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('observaciones') is-invalid @enderror" id="observaciones" name="observaciones" rows="3" placeholder="Información adicional relevante para el caso">{{ old('observaciones') }}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('fecha_ingreso') is-invalid @enderror" id="fecha_ingreso" name="fecha_ingreso" value="{{ old('fecha_ingreso', date('Y-m-d')) }}">
